...
\begin{flushleft}
{\Large
\textbf\newline{spmodel: Spatial Statistical Modeling and Prediction in \textbf{R} --
Supplementary Material} % Please use "sentence case" for title and headings (capitalize only the first word in a title (or heading), the first word in a subtitle (or subheading), and any proper nouns).
}
\newline
...
\bigskip
\textbf{\getAff{USEPA}}United States Environmental Protection Agency, 200 SW 35th St,
Corvallis, OR, 97333\\
...
Center, Marine Mammal Laboratory, Seattle, WA, 98115\\
\bigskip
