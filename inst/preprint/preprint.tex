...
\begin{flushleft}
{\Large
\textbf\newline{spmodel: spatial statistical modeling and prediction in \textbf{R}} % Please use "sentence case" for title and headings (capitalize only the first word in a title (or heading), the first word in a subtitle (or subheading), and any proper nouns).
}
\newline
