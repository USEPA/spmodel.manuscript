...
\hypertarget{spmodel-stuff}{%
\section{spmodel stuff}\label{spmodel-stuff}}

\hypertarget{introduction}{%
\subsection{Introduction}\label{introduction}}

\hypertarget{background-usage}{%
\subsection{Background / Usage}\label{background-usage}}

\hypertarget{splmm}{%
\subsubsection{splmm}\label{splmm}}

\hypertarget{generics}{%
\paragraph{generics}\label{generics}}

\hypertarget{spautor}{%
\subsubsection{spautor}\label{spautor}}

\hypertarget{generics-1}{%
\paragraph{generics}\label{generics-1}}
...
\hypertarget{big-data-local-index-method}{%
\subsubsection{big data (local index
method)}\label{big-data-local-index-method}}

\hypertarget{anisotropy}{%
\subsubsection{anisotropy}\label{anisotropy}}

\hypertarget{initial-values-and-known-values}{%
\subsubsection{initial values and known
values}\label{initial-values-and-known-values}}

\hypertarget{random-normal-simulation}{%
\subsubsection{random normal
simulation}\label{random-normal-simulation}}

\hypertarget{template-stuff}{%
\section{template stuff}\label{template-stuff}}
...
\begin{figure}
\centering
\includegraphics{preprint_files/figure-latex/fig2-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(}\KeywordTok{head}\NormalTok{(mtcars), }\DataTypeTok{caption =} \StringTok{"Head of mtcars table"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
