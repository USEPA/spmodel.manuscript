...
```
\noindent Here `.fitted` represents the predictions, `.lower` represents the lower bound of the 90% prediction intervals, and `.upper` represents the upper bound of the 95% prediction intervals.
...
\noindent `rand2` has the lowest AIC and AICc.
