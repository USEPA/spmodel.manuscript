...
abstract: |
  ...
  for a variety of spatial statistical models applied to point-referenced or areal data.
...
residuals(spmod)
```
The raw residuals are typically not directly checked for linear model assumptions, as they have covariance closely resembling the covariance of $\mathbf{y}$. These residuals can be whitened by pre-multiplying by $\boldsymbol{\Sigma}^{-1/2}$, yielding the Pearson residuals [@myers2012generalized]:
\begin{equation*}
